...
struct i2s_t {
	...
	void copy(volatile i2s_dev_t * dev)
	{
		memcpy((void*)((uint8_t*)this + 8), (const void*)((uint8_t*)dev + 8), sizeof(*this) - 8);
	}

	void dump()
	{
#define MEMBER(N) Serial.printf( #N " = %d,\r\n", N);
#include "i2s_members.h"
#undef MEMBER(N)
